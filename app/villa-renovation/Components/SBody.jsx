...
const villaSteps = [
  {
    ...
    desc: "We begin with a detailed consultation to understand your existing villa condition, renovation goals, lifestyle needs, design preferences, technical requirements, and budget. This helps us define a renovation direction that feels practical, elegant, and aligned with your vision.",
    img: "/images/mission.webp",
  },
  {
    id: "02",
    title: "Site Inspection & Space Evaluation",
    desc: "Our team carefully studies the current villa layout, circulation, structural possibilities, natural light, service requirements, room functions, and improvement opportunities. We then prepare a renovation plan that enhances comfort, usability, and overall spatial quality.",
    img: "/images/material.webp",
  },
  {
    id: "03",
    title: "Material, Finish & Scope Selection",
    desc: "We help you choose flooring, wall finishes, ceilings, joinery, lighting, sanitary fixtures, decorative elements, and renovation scope items that match your villa vision while ensuring durability, functionality, and long-term value.",
    img: "/images/customized.webp",
  },
  {
    id: "04",
    title: "Technical Drawings & Renovation Planning",
    desc: "Our designers and technical team prepare updated layouts, reflected ceiling plans, lighting drawings, joinery details, MEP coordination, and other renovation documents needed for smooth execution and accurate installation.",
    img: "/images/mission.webp",
  },
  {
    id: "05",
    title: "Renovation Execution & Installation",
    desc: "Once the design and materials are finalized, our craftsmen and project team begin the renovation process. From demolition and structural adjustments to fit-out, finishing, joinery, lighting, and installation, every stage is handled with precision and care.",
    img: "/images/material.webp",
  },
  {
    id: "06",
    title: "Final Finishing & Handover",
    desc: "Before handover, we complete final checks, snag corrections, finishing review, cleaning, and quality inspection so your renovated villa feels polished, functional, and ready for luxury living.",
    img: "/images/customized.webp",
  },
];
        ...
        <div className="bg-[#141517] py-16 mt-10">
          <div className="max-w-6xl mx-auto text-center px-4">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-conthrax mb-2 text-[#d4af37]">
              6-Step Process For Our Villa Renovation Services In Dubai
            </h2>
            <p className="font-play text-sm sm:text-base max-w-2xl mx-auto">
              ...
              and well-managed villa renovation services in Dubai.
            </p>
