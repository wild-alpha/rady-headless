    ...
    dropdown: [
      {
        ...
        href: "/design-services/palace-interior-design",
      },
      {
        name: "VILLA INTERIOR DESIGN",
        href: "/design-services/villa-interior-design",
      },
      {
        name: "APARTMENT INTERIOR DESIGN",
        href: "/design-services/apartment-interior-design",
      },
      {
        name: "PENTHOUSE INTERIOR DESIGN",
        href: "/design-services/penthouse-interior-design",
      },
      { name: "RESTAURANT DESIGN", href: "/design-services/restaurant-design" },
      {
        name: "CAFE INTERIOR DESIGN",
        href: "/design-services/cafe-interior-design",
      },
      {
        name: "OFFICE INTERIOR DESIGN",
        href: "/design-services/office-interior-design",
      },
      {
        name: "BEAUTY SALON DESIGN",
        href: "/design-services/beauty-salon-design",
      },
      {
        name: "RETAIL INTERIOR DESIGN",
        href: "/design-services/retail-interior-design",
      },
      { name: "EXTERIOR DESIGN", href: "/design-services/exterior-design" },
      {
        name: "PUBLIC SPACE DESIGN",
        href: "/design-services/public-space-design",
      },
      {
        name: "GYM INTERIOR DESIGN",
        href: "/design-services/gym-interior-design",
      },
      {
        name: "PRAYER ROOM INTERIOR DESIGN",
        href: "/design-services/prayer-room-interior-design",
      },
      {
        name: "MAJLIS INTERIOR DESIGN",
        href: "/design-services/majlis-interior-design",
      },
      {
        name: "LIVING ROOM DESIGN",
        href: "/design-services/living-room-design",
      },
      { name: "BEDROOM DESIGN", href: "/design-services/bedroom-design" },
      {
        name: "DRESSING ROOM DESIGN",
        href: "/design-services/dressing-room-design",
      },
      { name: "KIDS ROOM DESIGN", href: "/design-services/kids-room-design" },
      {
        name: "SWIMMING POOL DESIGN",
        href: "/design-services/swimming-pool-design",
      },
      {
        name: "SAUNA AND HAMMAM DESIGN",
        href: "/design-services/sauna-and-hammam-design",
      },
      {
        name: "KITCHEN INTERIOR DESIGN",
        href: "/design-services/kitchen-interior-design",
      },
      { name: "BATHROOM DESIGN", href: "/design-services/bathroom-design" },
    ],
  },
  {
    name: "FIT OUT WORKS",
    href: "/fit-out-works",
    dropdown: [
      { name: "COMMERCIAL FIT-OUT", href: "/fit-out-works/commercial-fit-out" },
      { name: "OFFICE FIT-OUT", href: "/fit-out-works/office-fit-out" },
      { name: "RESTAURANT FIT-OUT", href: "/fit-out-works/restaurant-fit-out" },
      { name: "RETAIL FIT-OUT", href: "/fit-out-works/retail-fit-out" },
      { name: "CUSTOMIZED JOINERY", href: "/fit-out-works/customized-joinery" },
      { name: "BESPOKE FURNITURE", href: "/fit-out-works/bespoke-furniture" },
      { name: "TURNKEY SOLUTIONS", href: "/fit-out-works/turnkey-solutions" },
    ],
  },
  {
    name: "RENOVATION",
    href: "/renovation",
    dropdown: [
      { name: "VILLA RENOVATION", href: "/renovation/villa-renovation" },
      {
        name: "APARTMENT RENOVATION",
        href: "/renovation/apartment-renovation",
      },
      { name: "OFFICE RENOVATION", href: "/renovation/office-renovation" },
      { name: "KITCHEN RENOVATION", href: "/renovation/kitchen-renovation" },
      { name: "BATHROOM RENOVATION", href: "/renovation/bathroom-renovation" },
      { name: "VILLA CONTRACTING", href: "/renovation/villa-contracting" },
    ],
  },
  {
    name: "AREAS WE SERVE",
    ...
    dropdown: [
      ...
      { name: "FUJAIRAH", href: "/areas-we-serve/fujairah" },
    ],
  },
  {
    name: "LANDSCAPE",
    href: "/landscape",
    dropdown: [
      { name: "LANDSCAPE SERVICES", href: "/landscape/services" },
      { name: "OUTDOOR KITCHENS", href: "/landscape/outdoor-kitchens" },
      { name: "BARBECUE (BBQ) AREAS", href: "/landscape/barbecue-bbq-areas" },
      { name: "SWIMMING POOLS", href: "/landscape/swimming-pools" },
      { name: "DECKING", href: "/landscape/decking" },
      { name: "OUTDOOR PLANTERS", href: "/landscape/outdoor-planters" },
    ],
  },
  {
    name: "GALLERY",
