...
const AboutSection = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full text-center">
            ...
            , we offer services for both commercial and residential
              projects. Our services related to office interior
              design in Palm Jumeirah help businesses create modern
              and productive workspaces. For commercial projects, 
              our interior design services in Palm Jumeirah, including
              retail outlets, restaurants, and hotels, ensure that every
              space is visually appealing, functional, and aligned with
              a luxury lifestyle.
              <br />
              <br />
              ...
              Our services help in designing homes that are comfortable,
              stylish, and modern. We combine custom furniture and 
              luxurious materials to suit the lifestyle of our clients.
              Our renovation services in Palm Jumeirah upgrade or 
              transform existing spaces with minimal disturbance. 
              With our creative and technical expertise, we are recognized
              as one of the best interior fit-out contractors in Palm Jumeirah and{" "}
              <b className="text-[#f0c95a]">
                <a href="https://radyinterior.ae/fit-out-company-in-business-bay-dubai">
                  a leading fit-out company in Palm Jumeirah, Dubai.
                </a>
              </b>
            ...
            <section className="bg-[#000000] py-10">
              <div className="container mx-auto flex flex-col lg:flex-row items-center px-4 sm:px-8 lg:px-16 gap-10">
                ...
                <div className="w-full lg:w-1/2 text-center lg:text-left">
                  ...
                  <p className="text-white text-sm sm:text-base font-play mb-4">
                    The commercial and mixed-use developments in Palm Jumeirah
                    feature some of the most luxurious offices, boutique businesses,
                    and high-end corporate spaces in Dubai. Our{" "}
                    <b className="text-[#f0c95a]">
                      <a href="https://radyinterior.ae/office-interior-design-trends-in-business-bay">
                       office interior design Palm Jumeirah services
                      </a>
                    </b>{" "}
                    focus on delivering environments that are functional,
                    inspiring, and aligned with the premium corporate 
                    standards of Dubai.
                  </p>
                  ...
                  <p className="text-white text-sm sm:text-base mb-4 font-play">
                    We oversee all the details involved in office and residential
                    fit-outs Dubai, such as space planning, furniture, lighting 
                    design, and technology. As professional offices and home 
                    fit-out contractors in Dubai, we also handle DCD approvals
                    and authority approvals Dubai to ensure that everything goes
                    smoothly. Other than Palm Jumeirah, our{" "}
                    <b className="text-[#f0c95a]">
                      <a href="https://radyinterior.ae/office-projects">
                        office interior design projects
                      </a>
                    </b>{" "}
                    interior design projects also cover the nearby areas of 
                    Al Sufouh and Jumeirah, which means that all businesses 
                    and residents in the main premium areas of Dubai get to 
                    enjoy our expertise.
              ...
              <div className="text-center mt-10">
                ...
                <p className="text-center max-w-6xl mx-auto mt-0 md:mt-4 text-[12px] sm:text-base text-white py-2 md:py-6 font-play">
                 ...
                 , we offer full-service turnkey fit-out Palm
                  Jumeirah services for our clients who are looking
                  for an all-in-one experience. As a reputable design
                  and build company in Dubai, we oversee all aspects 
                  of the process, from the first consultation and design
                  concept to approvals from the authorities Dubai, through
                  to completion and delivery. Our end-to-end process ensures
                  a smooth, efficient, and high-quality experience at all times.
                  Our clients can take advantage of our expertise in interior
            ...
            <section className="bg-[#000000] py-10">
              <div className="container mx-auto flex flex-col lg:flex-row items-center px-4 sm:px-8 lg:px-16 gap-10">
                ...
                <div className="w-full lg:w-1/2 text-center lg:text-left">
                  ...
                  <p className="text-white text-sm sm:text-base font-play mb-4">
                    ...
                    <b className="text-[#f0c95a]">
                      <a href="https://radyinterior.ae/apartment-interior-design-dubai">
                        Palm Jumeirah is known for its luxury residential properties, and our
                      </a>
                    </b>{" "}
                   apartment interior design in Palm Jumeirah Dubai services
                   are designed to provide you with luxurious, comfortable,
                   and contemporary living spaces. We are experts in luxury 
                   interior design Dubai and provide homes that are a perfect
                  ...
                  <p className="text-white text-sm sm:text-base mb-4 font-play">
                    ...
                    Oceana Residences and Golden Mile in Palm Jumeirah.
                    Whether it is a small apartment or a waterfront penthouse,
                    our interior design in Palm Jumeirah Dubai is a perfect blend
              ...
              <div className="text-center mt-10">
                <h2 className="text-[#d4af37] text-2xl font-conthrax mb-4 leading-tight">
                   Why Choose Rady Interior Design & Fitout in Palm Jumeirah
                </h2>
                <p className="text-center max-w-6xl mx-auto mt-0 md:mt-4 text-[12px] sm:text-base text-white py-2 md:py-6 font-play">
    ...
    Palm Jumeirah have good experience of working in luxury
    high-rise buildings and villas, ensuring that the work is done in the
    ...
    also includes the neighboring areas of Oceana Residences,
    Golden Mile and Jumeirah Road, making us the go-to
    choice for clients looking for the best interior design
    company in Palm Jumeirah.
                </p>
              </div>
            </section>
          </div>
        ...
        Palm Jumeirah, Rady Interior Design & Fitout is your best
        partner. From office interiors and retail outlets to
        apartments, penthouses, and villas, we work with every kind
        of space. Contact us today to schedule a consultation or site
        visit and experience expert interior design in Palm Jumeirah
    ...
    efficiency. From retail fit out Palm Jumeirah projects to{" "}
            <b className="text-[#f0c95a]">
    ...
    implementation. As a good reputed fit out company in Palm Jumeirah,
    ...
    the surrounding regions of Palm Jumeirah such as Jumeirah Road and
    Golden Mile. Our commercial designs are modern and elegant,
    making us one of the leading interior fit out companies in Dubai.
        ...
        Palm Jumeirah, including commercial offices,{" "}
                <b className="text-[#f0c95a]">
                  <a href="https://radyinterior.ae/business-bay-apartment-design">
                    luxury Palm Jumeirah apartment designs
                  </a>
                </b>
    ...
    upgrades finishes to provide the best interior designs that enhance both
    aesthetics and functionality of your space. We provide full
    renovation services in Palm Jumeirah and nearby locations. Our team
    ...
    functionality.
          ...
          <p className="text-left mx-auto mt-0 md:mt-4 text-[12px] sm:text-base text-white py-2 md:py-6 font-play">
             Although Palm Jumeirah is our main area of providing services, our
    ...
    successfully completed various projects including{" "}
            ...
            , Cafe Interiors, Palm Jumeirah restaurants, and apartment interiors
    ...
    fit-out solutions. Our status as one of the{" "}
            <b className="text-[#f0c95a]">
              <a href="https://radyinterior.ae/interior-design-companies-in-business-bay-dubai">
               best interior design companies in Palm Jumeirah
              </a>
            </b>{" "}
    ...
    approvals from DCD and other authorities in Dubai.
          </p>
          ...
          <p>
           Yes, our turnkey fit out services in Palm Jumeirah include all
    ...
    Palm Jumeirah and luxury residential projects, designing homes that
