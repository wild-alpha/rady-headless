...
const villaSteps = [
  {
    ...
    desc: "We begin with a detailed consultation to understand your salon concept, target audience, service offerings, brand style, workflow needs, and budget. This helps us shape an interior direction that feels attractive, practical, and aligned with your business identity.",
    img: "/images/mission.webp",
  },
  {
    id: "02",
    title: "Site Study & Space Planning",
    desc: "Our team studies the salon layout, customer movement, reception flow, treatment zones, waiting areas, storage needs, lighting conditions, and staff requirements. We then prepare a space plan that supports comfort, efficiency, and a premium client experience.",
    img: "/images/material.webp",
  },
  {
    id: "03",
    title: "Material, Furniture & Finish Selection",
    desc: "We help you select flooring, wall finishes, mirrors, salon stations, reception counters, lighting, chairs, display units, and decorative materials that reflect your beauty salon image while maintaining durability and easy maintenance.",
    img: "/images/customized.webp",
  },
  {
    id: "04",
    title: "Technical Drawings & Design Detailing",
    desc: "Our designers and technical team prepare salon layouts, joinery drawings, reflected ceiling plans, lighting layouts, service area details, and other documents needed for smooth fit-out planning and coordinated execution.",
    img: "/images/mission.webp",
  },
  {
    id: "05",
    title: "Fit-Out Execution & Installation",
    desc: "Once the design is approved, our project team and craftsmen begin transforming the salon. From partitions and flooring to counters, mirrors, styling stations, lighting, and final finishes, every stage is executed with attention to detail.",
    img: "/images/material.webp",
  },
  {
    id: "06",
    title: "Final Styling & Handover",
    desc: "Before handover, we complete finishing checks, styling details, accessory placement, snag corrections, and quality review to ensure your beauty salon is polished, welcoming, and ready for business.",
    img: "/images/customized.webp",
  },
];
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="w-full lg:w-1/2 flex flex-col justify-start">
              <h2 className="text-sm sm:text-xl md:text-xl font-bold tracking-widest py-2 text-[#d4af37]">
                Premium beauty salon interior design services in Dubai
              </h2>
        ...
        <div className="bg-[#141517] py-16 mt-10">
          <div className="max-w-6xl mx-auto text-center px-4">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-conthrax mb-2 text-[#d4af37]">
              6-Step Process For Our Beauty Salon Design Services In Dubai
            </h2>
            <p className="font-play text-sm sm:text-base max-w-2xl mx-auto">
              We follow a clear and transparent 6-step process to deliver
              well-planned beauty salon interior design services in Dubai.
            </p>
