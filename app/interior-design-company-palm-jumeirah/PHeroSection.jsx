      ...
      <div className="relative z-20 flex items-center h-full">
        <div className="max-w-6xl px-6 md:px-16 text-white">
          ...
          <p className="font-play mt-6 max-w-2xl text-gray-200">
           Rady Interior Design & Fitout is a leading Interior
            Design Company in Palm Jumeirah, Dubai, and provides
             the best interior design services for residential, 
             commercial, and retail projects. Palm Jumeirah is
              one of the most prominent areas of Dubai as it is
               famous for its luxurious beachfront villas, iconic
                hotels, upscale apartments, and vibrant lifestyle
                 destinations.
          </p>
