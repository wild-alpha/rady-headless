...
const villaSteps = [
  {
    ...
    desc: "We begin with a detailed consultation to understand your child’s age, daily routine, interests, storage needs, safety requirements, design preferences, and budget. This helps us create a kids room concept that feels playful, practical, and comfortable.",
    img: "/images/mission.webp",
  },
  {
    id: "02",
    title: "Site Study & Space Planning",
    desc: "Our team studies the room layout, natural light, circulation, furniture placement, storage opportunities, study needs, and play zones. We then prepare a space plan that improves comfort, safety, organization, and flexibility as your child grows.",
    img: "/images/material.webp",
  },
  {
    id: "03",
    title: "Material, Furniture & Finish Selection",
    desc: "We help you choose child-friendly finishes, beds, wardrobes, study desks, shelving, lighting, wall treatments, and décor elements that match the room style while ensuring safety, durability, and easy maintenance.",
    img: "/images/customized.webp",
  },
  {
    id: "04",
    title: "Technical Drawings & Design Detailing",
    desc: "Our designers and technical team prepare kids room layouts, wardrobe drawings, study unit details, ceiling plans, lighting layouts, and other documents required for accurate planning and smooth execution.",
    img: "/images/mission.webp",
  },
  {
    id: "05",
    title: "Fit-Out Execution & Installation",
    desc: "Once the design is finalized, our craftsmen and project team begin the room transformation. From wall finishes and flooring to custom furniture, storage units, lighting, and décor installations, every element is executed with care.",
    img: "/images/material.webp",
  },
  {
    id: "06",
    title: "Final Styling & Handover",
    desc: "Before handover, we complete final styling, finishing checks, furniture arrangement, accessory placement, and quality review so the kids room feels cheerful, organized, and ready for everyday living.",
    img: "/images/customized.webp",
  },
];
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="w-full lg:w-1/2 flex flex-col justify-start">
              <h2 className="text-sm sm:text-xl md:text-xl font-bold tracking-widest py-2 text-[#d4af37]">
                Premium kids room interior design services in Dubai
              </h2>
